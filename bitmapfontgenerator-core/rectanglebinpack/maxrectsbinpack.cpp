...
Rect MaxRectsBinPack::Insert(int width, int height, FreeRectChoiceHeuristic method)
{
	...
	switch(method)
	{
        case FreeRectChoiceHeuristic::BestShortSideFit: newNode = FindPositionForNewNodeBestShortSideFit(width, height, score1, score2); break;
        case FreeRectChoiceHeuristic::BottomLeftRule: newNode = FindPositionForNewNodeBottomLeft(width, height, score1, score2); break;
        case FreeRectChoiceHeuristic::ContactPointRule: newNode = FindPositionForNewNodeContactPoint(width, height, score1); break;
        case FreeRectChoiceHeuristic::BestLongSideFit: newNode = FindPositionForNewNodeBestLongSideFit(width, height, score2, score1); break;
        case FreeRectChoiceHeuristic::BestAreaFit: newNode = FindPositionForNewNodeBestAreaFit(width, height, score1, score2); break;
	}
...
Rect MaxRectsBinPack::ScoreRect(int width, int height, FreeRectChoiceHeuristic method, int &score1, int &score2) const
{
    ...
    case FreeRectChoiceHeuristic::BestShortSideFit: newNode = FindPositionForNewNodeBestShortSideFit(width, height, score1, score2); break;
    case FreeRectChoiceHeuristic::BottomLeftRule: newNode = FindPositionForNewNodeBottomLeft(width, height, score1, score2); break;
    case FreeRectChoiceHeuristic::ContactPointRule: newNode = FindPositionForNewNodeContactPoint(width, height, score1);
